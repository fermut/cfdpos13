...
# /                  /                          /
# |     dW           |                          | dp
# | rho -- dOmega  - | mu grad(W).nG dGamma = - | -- dOmega
# |     dt           |                          | dz
# / Omega            / Gamma                    / Omega
#
...
# and dp/dz(t) is the applied (time-dependent) pressure gradient.
...
Ai = (rho/dt)*Am + theta*Af;
Ae = (rho/dt)*Am - (1-theta)*Af;
